...
// 3A - copy constructor and copy assignment
// 3B - move constructor and move assignment
// 3C - copy + move constructor + assignment
...
// milestone 4 should be answered in short_answers.txt
