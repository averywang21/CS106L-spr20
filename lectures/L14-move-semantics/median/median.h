...
namespace mycollection {
    ...
    public:
        ...
        StreamingMedianTracker(const StreamingMedianTracker<T, Compare>& other) = delete;
        StreamingMedianTracker<T, Compare>& operator=(const StreamingMedianTracker<T, Compare>& rhs) = delete;
